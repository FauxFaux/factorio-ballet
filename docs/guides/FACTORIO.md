...
voluminous, and travel through pipes with unlimited throughput, so each fluid type needs only one
pipe. Items stay on belts whose progress-dependent throughput ranges from 15 to 75 items per second.
